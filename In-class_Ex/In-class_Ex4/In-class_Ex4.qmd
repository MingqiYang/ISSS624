...
In this lesson, we will learn the basic concepts and methods of geographically weighted regression.
...
[**A short note about GWmodel:**]{.underline}
...
#### 3.1.1 Importing geospatial data
...
#### 3.1.2 Updating CRS information
...
#### 3.2.2 Converting aspatial data frame into a sf object
