...
In this hands-on exercise, the key R package use is [**tmap**](https://cran.r-project.org/web/packages/tmap/) package in R.
...
#### 4.3.2 Plotting choropleth map with customized break
